class FabricatProductsModelCopy {
  bool success;
  List<FabricatCategoriesModelCopy> data;
  String message;

  FabricatProductsModelCopy({this.success, this.data, this.message});
...
class FabricatCategoriesModelCopy {
  FabricatCategoriesCopy categories;
  String categoryName;

  FabricatCategoriesModelCopy({this.categories, this.categoryName});

  FabricatCategoriesModelCopy.fromJson(Map<String, dynamic> json) {
    categories = json['categories'] != null
        ? new FabricatCategoriesCopy.fromJson(json['categories'])
        : null;
...
class FabricatCategoriesCopy {
  ...
  int sort;
  int visable;
  List<FabricatProductModelCopy> products;
...
class FabricatProductModelCopy {
  int id;
  String images;
  String title;
  String content;
