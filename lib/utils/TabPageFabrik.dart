...
class _TabPageFabrilState extends State<TabPageFabril>
    ...
    _controller.addListener(
      () {
        Provider.of<ListViewProvider>(context, listen: false)
            .goToIndexFabrik(_controller.index);
      },
    );
  }
    ...
    return Scaffold(
      appBar: AluxAppBar(
        bottom: PreferredSize(
          preferredSize:
              provide.isSearchMode ? Size.fromHeight(100) : Size.fromHeight(40),
          child: Column(
            children: [
              AnimatedContainer(
                duration: Duration(milliseconds: 400),
                height: provide.isSearchMode ? 50 : 0,
                child: provide.isSearchMode
                    ? Padding(
