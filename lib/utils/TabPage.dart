...
class TabPage extends StatefulWidget {
  ...
  final content;
  TabPage({ Key key, this.tabs, this.views,this.content ,this.length})
    : super(key: key);
...
class _TabPageState extends State<TabPage> with TickerProviderStateMixin {
  ...
  void initState() {
   ...
   var p = Provider.of<ListViewProvider>(context,listen: false);
    retrieveTabs(p.categoriesModel);
  }
  Future retrieveTabs(cats)async{
   ...
   _controller.addListener(() {
     Provider.of<ListViewProvider>(context,listen: false).goToIndex(_controller.index);
   },);
  }
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: TextField(
                          ...
                          onChanged: (search){
                            provide.filterSearchResults(search);
                          }
                      ),
                    ),
                  ),
