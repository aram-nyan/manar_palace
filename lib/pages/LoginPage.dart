      ...
      content: Container(
        ...
        child: Form(
          child: Column(
            ...
            children: [
              Text('Введите e-mail или номер телефона, чтобы войти или зарегистрироваться',
                style: TextStyle( fontSize: 16 ),
              ),
              SizedBox(height: 16,),
              CustomTextField(hintText: 'E-mail или номер телефона',
                padding: 16.0,
                onChanged: (value){
              ...
              AppButton(
                ...
                onPressed: () {
                  if(auth.isChecked){
                    Provider.of<AuthProvide>(context,listen: false).login(context);
                  }else{
